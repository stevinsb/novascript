...
import 'package:basic_flutter/shiftoutsup.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Safetyinwor extends StatefulWidget {
  const Safetyinwor({super.key});

  @override
  State<Safetyinwor> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<Safetyinwor> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: 3, vsync: this);
     ...
     _tabController.addListener(() {
      ...
      //   Navigator.push(
      //     context,
      //     MaterialPageRoute(builder: (context) => Safetyinwor()),
      //   );
      // }
    });
  }
